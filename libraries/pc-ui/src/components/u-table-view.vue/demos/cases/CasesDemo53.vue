<!-- 纯数组前端分页 -->
<template>
  <u-table-view striped :showFooterCalcRow="true" footerCalcText="统计" footerCalcOption="average" :data="data" pageable :page-size="10" :pageSizeOptions="[9,10]">
    <u-table-view-column title="用户名" field="name" width="15%"></u-table-view-column>
    <u-table-view-column title="手机号码" field="phone" width="20%"></u-table-view-column>
    <u-table-view-column title="数量" field="count" width="20%"></u-table-view-column>
